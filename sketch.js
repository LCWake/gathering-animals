...
var pig, pigImg, pigGroup;
var duck, duckImg, duckGroup;
var owl, owlImg;
...
function setup() {
  ...
  rabbit6.scale = 0.145
  //making cows
  cow1 = createSprite(random(100, 500), random(70, 300))
  cow1.addImage("baby cow", cowImg)
  cow1.scale = 0.145
  cow2 = createSprite(random(100, 500), random(70, 300))
  cow2.addImage("baby cow", cowImg)
  cow2.scale = 0.145
  cow3 = createSprite(random(100, 500), random(70, 300))
  cow3.addImage("baby cow", cowImg)
  cow3.scale = 0.145
  cow4 = createSprite(random(100, 500), random(70, 300))
  cow4.addImage("baby cow", cowImg)
  cow4.scale = 0.145
  cow5 = createSprite(random(100, 500), random(70, 300))
  cow5.addImage("baby cow", cowImg)
  cow5.scale = 0.145
  cow6 = createSprite(random(100, 500), random(70, 300))
